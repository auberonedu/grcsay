...
1. Each partner should run these commands on their own terminal. DO NOT SKIP THIS PART!!! I said "DO NOT SKIP SIR!" Partner A is creating a merge conflict on my end!
    ```
